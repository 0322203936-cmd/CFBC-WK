...
function showProductos(rancho, tipo, weekNum, yr) {
  ...
  console.log('rancho:', rancho, '| tipo:', tipo, '| semCode:', semCode);
  console.log('semanas disponibles:', Object.keys(allProds));
  var prods = allProds[semCode] || allProds[semCodeStr] || null;
  console.log('prods para semana:', prods ? Object.keys(prods) : 'NULL');
  var list = [];
  if(prods){
